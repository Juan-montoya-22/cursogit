...
| Selector de rol | Home Padre | Mapa | Perfil guardería |
|:-:|:-:|:-:|:-:|
| *(pantalla de inicio)* | *(lista de guarderías)* | *(mapa OSM)* | *(detalle completo)* |
...
3. Realice sus cambios y haga commit: `git commit -m "feat: descripción del cambio"`
4. Haga push a su rama: `git push origin feature/nueva-funcionalidad`
5. Abra un Pull Request describiendo los cambios realizados.
...
Este proyecto fue desarrollado como trabajo de grado en la **Universidad de Cundinamarca** — Facultad de Ingeniería y Ciencias Básicas, programa Ingeniería de Sistemas.

Distribuido bajo licencia MIT. Consulte el archivo [LICENSE](LICENSE) para más información.

---

<p align="center">
  🐾 <strong>RapiKids</strong> · Bogotá, Colombia · 2025
</p>
